-- CloseTrack Database Schema Setup (Safe Version)
...
CREATE INDEX idx_deadlines_transaction_id ON deadlines(transaction_id);
CREATE INDEX idx_checklists_transaction_id ON checklists(transaction_id);
